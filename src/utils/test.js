(function (root) {
	const GitHubColors = {
		get: function (lang, handleOthers) {
		...
		colors: {
			ABAP: { type: "programming", color: "#E8274B", extensions: [".abap"], ace_mode: "abap" },
			"AGS Script": {
				type: "programming",
				color: "#B9D9FF",
				aliases: ["ags"],
			...
			ANTLR: { type: "programming", color: "#9DC3FF", extensions: [".g4"], ace_mode: "text" },
			"API Blueprint": {
				type: "markup",
				color: "#2ACCA8",
				ace_mode: "markdown",
			...
			Agda: { type: "programming", color: "#315665", extensions: [".agda"], ace_mode: "text" },
			Alloy: { type: "programming", color: "#cc5c24", extensions: [".als"], ace_mode: "text" },
			"Ant Build System": {
				type: "data",
			...
			Augeas: { type: "programming", extensions: [".aug"], tm_scope: "none", ace_mode: "text" },
			AutoHotkey: {
				type: "programming",
				color: "#6594b9",
				aliases: ["ahk"],
			...
			Befunge: { type: "programming", extensions: [".befunge"], ace_mode: "text" },
			Bison: {
				type: "programming",
			...
			BitBake: { type: "programming", tm_scope: "none", extensions: [".bb"], ace_mode: "text" },
			BlitzBasic: {
				type: "programming",
			...
			Boo: { type: "programming", color: "#d4bec1", extensions: [".boo"], ace_mode: "text" },
			Brainfuck: {
				type: "programming",
				color: "#2F2530",
				extensions: [".b", ".bf"],
			...
			Bro: { type: "programming", extensions: [".bro"], ace_mode: "text" },
			C: {
				type: "programming",
				color: "#555555",
			...
			Ceylon: { type: "programming", extensions: [".ceylon"], ace_mode: "text" },
			Chapel: {
				type: "programming",
				color: "#8dc63f",
				aliases: ["chpl"],
			...
			Cirru: { type: "programming", color: "#ccccff", ace_mode: "cirru", extensions: [".cirru"] },
			Clarion: {
				type: "programming",
				color: "#db901e",
				ace_mode: "text",
			...
			CoffeeScript: {
				...
				extensions: [".coffee", "._coffee", ".cjsx", ".cson", ".iced"],
				filenames: ["Cakefile"],
				interpreters: ["coffee"],
			},
			ColdFusion: {
			...
			"Common Lisp": {
				...
				color: "#3fb68b",
				aliases: ["lisp"],
				extensions: [".lisp", ".asd", ".cl", ".lsp", ".ny", ".podsl"],
			...
			Cool: { type: "programming", extensions: [".cl"], tm_scope: "source.cool", ace_mode: "text" },
			Coq: { type: "programming", extensions: [".coq", ".v"], ace_mode: "text" },
			"Cpp-ObjDump": {
				type: "data",
			...
			D: { type: "programming", color: "#fcd46d", extensions: [".d", ".di"], ace_mode: "d" },
			"D-ObjDump": {
				type: "data",
			...
			Dart: { type: "programming", color: "#00B4AB", extensions: [".dart"], ace_mode: "dart" },
			Diff: {
				type: "data",
				color: "#88dddd",
			...
			Eiffel: { type: "programming", color: "#946d57", extensions: [".e"], ace_mode: "eiffel" },
			Elixir: {
				type: "programming",
				color: "#6e4a7e",
				extensions: [".ex", ".exs"],
			...
			Formatted: { type: "data", extensions: [".for"], tm_scope: "none", ace_mode: "text" },
			Forth: {
				type: "programming",
				color: "#341708",
			...
			GAMS: { type: "programming", extensions: [".gms"], tm_scope: "none", ace_mode: "text" },
			GAP: {
				type: "programming",
			...
			Go: { type: "programming", color: "#375eab", extensions: [".go"], ace_mode: "golang" },
			Golo: {
				type: "programming",
				color: "#88562A",
				extensions: [".golo"],
			...
			"HTML+Django": {
				...
				aliases: ["html+django/jinja", "html+jinja", "htmldjango"],
				ace_mode: "django",
			},
			"HTML+ERB": {
				type: "markup",
			...
			HTTP: { type: "data", extensions: [".http"], tm_scope: "source.httpspec", ace_mode: "text" },
			Hack: {
				type: "programming",
				ace_mode: "php",
				extensions: [".hh", ".php"],
			...
			HyPhy: { type: "programming", ace_mode: "text", extensions: [".bf"], tm_scope: "none" },
			IDL: {
				type: "programming",
				color: "#a3522f",
				extensions: [".pro", ".dlm"],
			...
			Idris: { type: "programming", extensions: [".idr", ".lidr"], ace_mode: "text" },
			"Inform 7": {
				type: "programming",
				wrap: true,
				extensions: [".ni", ".i7x"],
			...
			Io: { type: "programming", color: "#a9188d", extensions: [".io"], ace_mode: "io" },
			Ioke: {
				type: "programming",
				color: "#078193",
				extensions: [".ik"],
			...
			JSON: {
				...
				filenames: [".jshintrc", "composer.lock"],
			},
			JSON5: {
				type: "data",
				extensions: [".json5"],
			...
			Java: { type: "programming", ace_mode: "java", color: "#b07219", extensions: [".java"] },
			"Java Server Pages": {
				type: "programming",
				group: "Java",
				search_term: "jsp",
			...
			Julia: { type: "programming", extensions: [".jl"], color: "#a270ba", ace_mode: "julia" },
			KRL: {
				type: "programming",
				color: "#28431f",
				extensions: [".krl"],
			...
			KiCad: { type: "programming", extensions: [".sch"], tm_scope: "none", ace_mode: "text" },
			Kit: { type: "markup", ace_mode: "html", extensions: [".kit"], tm_scope: "text.html.basic" },
			Kotlin: {
				type: "programming",
				color: "#EA4DFA",
			...
			LLVM: { type: "programming", extensions: [".ll"], ace_mode: "text" },
			LOLCODE: {
				type: "programming",
				extensions: [".lol"],
				color: "#cc9900",
			...
			LabVIEW: { type: "programming", extensions: [".lvproj"], tm_scope: "none", ace_mode: "text" },
			Lasso: {
				type: "programming",
				color: "#999999",
			...
			Lean: { type: "programming", extensions: [".lean", ".hlean"], ace_mode: "lean" },
			Less: {
				type: "markup",
				group: "CSS",
				extensions: [".less"],
			...
			LilyPond: { type: "programming", extensions: [".ly", ".ily"], ace_mode: "text" },
			Limbo: { type: "programming", extensions: [".b", ".m"], tm_scope: "none", ace_mode: "text" },
			"Linker Script": {
				type: "data",
				extensions: [".ld", ".lds"],
				filenames: ["ld.script"],
			...
			Logos: { type: "programming", extensions: [".xm", ".x", ".xi"], ace_mode: "text" },
			Logtalk: { type: "programming", extensions: [".lgt", ".logtalk"], ace_mode: "text" },
			LookML: {
				type: "programming",
				ace_mode: "yaml",
				color: "#652B81",
			...
			Mathematica: {
				type: "programming",
				extensions: [".mathematica", ".cdf", ".m", ".ma", ".nb", ".nbp", ".wl", ".wlt"],
				aliases: ["mma"],
				ace_mode: "text",
			},
			Matlab: {
			...
			Monkey: { type: "programming", extensions: [".monkey"], ace_mode: "text" },
			Moocode: { type: "programming", extensions: [".moo"], tm_scope: "none", ace_mode: "text" },
			MoonScript: {
				type: "programming",
				extensions: [".moon"],
				interpreters: ["moon"],
			...
			Myghty: { type: "programming", extensions: [".myt"], tm_scope: "none", ace_mode: "text" },
			NL: { type: "data", extensions: [".nl"], tm_scope: "none", ace_mode: "text" },
			NSIS: { type: "programming", extensions: [".nsi", ".nsh"], ace_mode: "text" },
			Nemerle: { type: "programming", color: "#3d3c6e", extensions: [".n"], ace_mode: "text" },
			NetLinx: {
				type: "programming",
				color: "#0aa0ff",
				extensions: [".axs", ".axi"],
			...
			Ninja: { type: "data", tm_scope: "source.ninja", extensions: [".ninja"], ace_mode: "text" },
			Nit: {
				type: "programming",
				color: "#009917",
				extensions: [".nit"],
			...
			Opa: { type: "programming", extensions: [".opa"], ace_mode: "text" },
			Opal: {
				type: "programming",
				color: "#f7ede0",
				extensions: [".opal"],
			...
			Org: { type: "prose", wrap: true, extensions: [".org"], tm_scope: "none", ace_mode: "text" },
			Ox: {
				type: "programming",
			...
			PHP: {
				...
				ace_mode: "php",
				color: "#4F5D95",
				extensions: [".php", ".aw", ".ctp", ".fcgi", ".php3", ".php4", ".php5", ".phpt"],
				filenames: ["Phakefile"],
				interpreters: ["php"],
				aliases: ["inc"],
			},
			...
			Perl: {
				...
				ace_mode: "perl",
				color: "#0298c3",
				extensions: [".pl", ".cgi", ".fcgi", ".perl", ".ph", ".plx", ".pm", ".pod", ".psgi", ".t"],
				interpreters: ["perl"],
			},
			Perl6: {
				type: "programming",
			...
			Pod: { type: "prose", ace_mode: "perl", wrap: true, extensions: [".pod"], tm_scope: "none" },
			PogoScript: {
				type: "programming",
				color: "#d80074",
				extensions: [".pogo"],
			...
			Processing: { type: "programming", color: "#0096D8", extensions: [".pde"], ace_mode: "text" },
			Prolog: {
				type: "programming",
				color: "#74283c",
				extensions: [".pl", ".ecl", ".pro", ".prolog"],
				interpreters: ["swipl"],
				ace_mode: "prolog",
			},
			"Propeller Spin": {
			...
			Python: {
				...
				filenames: ["BUILD", "SConscript", "SConstruct", "Snakefile", "wscript"],
			...
			Redcode: { type: "programming", extensions: [".cw"], tm_scope: "none", ace_mode: "text" },
			RenderScript: {
				type: "programming",
				extensions: [".rs", ".rsh"],
				tm_scope: "none",
			...
			Ruby: {
				...
				interpreters: ["ruby", "macruby", "rake"],
				filenames: [
					".pryrc",
					"Appraisals",
					"Berksfile",
			...
			Rust: { type: "programming", color: "#dea584", extensions: [".rs"], ace_mode: "rust" },
			SAS: {
				type: "programming",
				color: "#B34936",
				extensions: [".sas"],
			...
			SQL: {
				...
				tm_scope: "source.sql",
				ace_mode: "sql",
				extensions: [".sql", ".cql", ".ddl", ".prc", ".tab", ".udf", ".viw"],
			},
			SQLPL: {
				type: "programming",
				ace_mode: "sql",
			...
			SVG: { type: "data", extensions: [".svg"], tm_scope: "text.xml", ace_mode: "xml" },
			Sage: {
				type: "programming",
				group: "Python",
			...
			Scheme: {
				...
				interpreters: ["guile", "bigloo", "chicken"],
				ace_mode: "scheme",
			},
			Scilab: { type: "programming", extensions: [".sci", ".sce", ".tst"], ace_mode: "text" },
			Self: {
				type: "programming",
				color: "#0579aa",
				extensions: [".self"],
			...
			Smarty: { type: "programming", extensions: [".tpl"], ace_mode: "smarty" },
			SourcePawn: {
				type: "programming",
				color: "#5c7611",
				aliases: ["sourcemod"],
			...
			Swift: { type: "programming", color: "#ffac45", extensions: [".swift"], ace_mode: "text" },
			SystemVerilog: {
				type: "programming",
				color: "#DAE1C2",
			...
			TOML: { type: "data", extensions: [".toml"], tm_scope: "source.toml", ace_mode: "toml" },
			TXL: { type: "programming", extensions: [".txl"], tm_scope: "source.txl", ace_mode: "text" },
			Tcl: {
				type: "programming",
				color: "#e4cc98",
			...
			Tea: { type: "markup", extensions: [".tea"], tm_scope: "source.tea", ace_mode: "text" },
			Text: {
				type: "prose",
				wrap: true,
				aliases: ["fundamental"],
			...
			Turtle: { type: "data", extensions: [".ttl"], tm_scope: "source.turtle", ace_mode: "text" },
			Twig: {
				type: "markup",
				group: "HTML",
				extensions: [".twig"],
			...
			XS: { type: "programming", extensions: [".xs"], tm_scope: "source.c", ace_mode: "c_cpp" },
			XSLT: {
				type: "programming",
				aliases: ["xsl"],
				extensions: [".xslt", ".xsl"],
			...
			Xtend: { type: "programming", extensions: [".xtend"], ace_mode: "text" },
			YAML: {
				type: "data",
				tm_scope: "source.yaml",
				aliases: ["yml"],
				extensions: [".yml", ".reek", ".rviz", ".yaml"],
				ace_mode: "yaml",
			},
			Zephir: {
				type: "programming",
			...
			mupad: { type: "programming", extensions: [".mu"], ace_mode: "text" },
			nesC: { type: "programming", color: "#94B0C7", extensions: [".nc"], ace_mode: "text" },
			ooc: { type: "programming", color: "#b0b77e", extensions: [".ooc"], ace_mode: "text" },
			reStructuredText: {
				type: "prose",
				wrap: true,
				search_term: "rst",
